hey = { word: 'culture',
  ...
  meanings:
   [ [ [ { definition: 'all the knowledge and values shared by a society',
           ...
           supertypes:
            [ { word: [ 'cognitive content', 'content', 'mental object' ],
                definition:
         ...
         { definition: 'all the knowledge and values shared by a society',
           ...
           subtypes:
            [ { word:
              ...
              { word: [ 'Western civilization', 'Western culture' ],
                definition: 'the modern culture of western Europe and North America' },
              { word:
                 [ 'Cyclades',
       ...
       [ { definition:
           ...
           subtypes:
            [ { word: [ 'cyberculture' ],
              ...
              { word: [ 'mosaic culture' ],
                definition: 'a highly diverse culture' } ],
           supertypes:
            [ { word: [ 'attitude', 'mental attitude' ],
                definition:
         ...
         { definition:
           ...
           subtypes:
            [ { word: [ 'counterculture' ],
              ...
              { word: [ 'mass culture' ],
                definition: 'the culture that is widely disseminated via the mass media' },
              { word: [ 'letters' ], definition: 'the literary culture' },
              { word: [ 'flower power' ],
                definition:
                 'a counterculture of young people in the US during the 1960s and 70s' } ],
           supertypes:
            [ { word: [ 'appreciation', 'discernment', 'perceptiveness', 'taste' ],
     ...
     [ [ { definition:
       ...
       [ { definition: 'grow in a special preparation',
           pos: 'verb',
           synsetid: 's83283',
           supertypes:
            [ { word: [ 'grow' ], definition: 'cause to grow or develop' } ] } ] ],
     [ [ { definition: 'the raising of plants or animals',
           pos: 'noun',
           synsetid: 's4684',
           subtypes:
            [ { word: [ 'cranberry culture' ],
                definition: 'the cultivation of cranberries' },
              { word: [ 'monoculture' ],
                definition:
                 'the cultivation of a single crop (on a farm or area or country)' },
              { word: [ 'tillage' ],
                definition: 'the cultivation of soil for raising crops' },
              { word: [ 'viniculture', 'viticulture' ],
                definition: 'the cultivation of grapes and grape vines; grape growing' } ],
           supertypes:
            [ { word: [ 'cultivation' ],
                definition:
     ...
     [ [ { definition:
           ...
           supertypes:
            [ { word: [ 'flawlessness', 'ne plus ultra', 'perfection' ],
